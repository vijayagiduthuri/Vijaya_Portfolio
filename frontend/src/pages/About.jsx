...
//             <div
//               className={`relative flex p-0.5 rounded-xl mb-6 w-full max-w-2xl ${
//                 isDarkMode
...
//                   className={`relative min-w-0 flex items-center justify-center gap-2 px-2 py-2 rounded-lg text-sm font-medium transition-all duration-300 flex-1 ${
//                     activeTab === tab.id
...
//           >
//             {activeTab === "education" && (
//               <div className="w-full max-w-2xl px-4 sm:px-6 md:px-8 py-6 space-y-6 mx-auto">
